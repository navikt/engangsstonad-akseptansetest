...
sevenMonthsAgo.setDate(sevenMonthsAgo.getMonth() - 7)
...
test('must be sent without errors', async t => {
   await t
      ...
      .typeText(tilknytningTilNorgePage.boILandFraDato, dateFormat(sevenMonthsAgo, "dd.mm.yyyy"))
      .typeText(tilknytningTilNorgePage.boILandTilDato, dateFormat(oneMonthAgo, "dd.mm.yyyy"))
